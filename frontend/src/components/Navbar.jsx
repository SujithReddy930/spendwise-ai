...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav
        className={`md:hidden fixed bottom-0 left-0 right-0 ${bg} border-t z-50`}
        style={{
          paddingBottom:
      ...
      >
        {showMobileMenu && (
          ...
          >
            ...
            <button
              onClick={toggle}
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm ${textMuted} ${hoverBg}`}
            >
            ...
            <button
              onClick={handleLogout}
              className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-red-400 hover:bg-red-900/20"
            >
              <LogOut size={17} />
              Logout
            </button>
